...
class TestUnderstat(object):
    ...
    async def test_get_stats(self, event_loop, understat):
        stats = await understat.get_stats()
        assert isinstance(stats, list)

    async def test_get_stats_with_options(self, event_loop, understat):
    ...
    async def test_get_teams(self, event_loop, understat):
        for league in leagues:
            teams = await understat.get_teams(league, 2018)
            assert isinstance(teams, list)

    async def test_get_team_with_options(self, event_loop, understat):
    ...
    async def test_get_league_players(self, event_loop, understat):
        for league in leagues:
            players = await understat.get_league_players(league, 2018)
            assert isinstance(players, list)

    async def test_get_league_players_with_options(self, event_loop, understat):
    ...
    async def test_get_league_results(self, event_loop, understat):
        for league in leagues:
    ...
    async def test_get_league_results_with_options(self, event_loop, understat):
    ...
    async def test_get_league_fixtures(self, event_loop, understat):
        for league in leagues:
    ...
    async def test_get_league_fixtures_with_options(self, event_loop, understat):
        results = await understat.get_league_fixtures("epl", 2022, {
            "h": {"id": "89",
                  "title": "Manchester United",
                  "short_title": "MUN"}
        })
    ...
    async def test_get_matches(self, event_loop, understat):
        player_matches = await understat.get_player_matches(619)
        assert isinstance(player_matches, list)

    async def test_get_matches_with_options(self, event_loop, understat):
    ...
    async def test_get_player_stats(self, event_loop, understat):
    ...
    async def test_get_team_fixtures(self, event_loop, understat):
        fixtures = await understat.get_team_fixtures("Manchester United", 2018)
        assert isinstance(fixtures, list)

    async def test_get_team_fixtures_with_options(self, event_loop, understat):
    ...
    async def test_get_team_players(self, event_loop, understat):
        players = await understat.get_team_players("Manchester United", 2018)
        assert isinstance(players, list)

    async def test_get_team_players_with_options(self, event_loop, understat):
